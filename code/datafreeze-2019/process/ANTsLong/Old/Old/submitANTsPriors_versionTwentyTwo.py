...
outdir = '/project/ExtraLong/data/groupTemplates/versionTwentyTwo/'
...
dataToBind = dataToBind+'-B /project/ExtraLong/data/groupTemplates/versionTwentyTwo:/data/output '
...
cmd = ['SINGULARITYENV_projectName=ExtraLong', 'SINGULARITYENV_NumSSTs=8',
        ...
        '/project/ExtraLong/images/antspriors_0.0.32.sif', '/scripts/run.sh']
