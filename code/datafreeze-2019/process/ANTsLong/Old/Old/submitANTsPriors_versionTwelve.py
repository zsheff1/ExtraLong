...
outdir = '/project/ExtraLong/data/groupTemplates/versionTwelve/'
...
dataToBind = dataToBind+'-B /project/ExtraLong/data/groupTemplates/versionTwelve:/data/output '
...
cmd = ['SINGULARITYENV_projectName=ExtraLong', 'singularity', 'exec',
        ...
        '/project/ExtraLong/images/antspriors_0.0.19.sif', '/scripts/run.sh']
