...
outdir = '/project/ExtraLong/data/groupTemplates/versionThirteen/'
...
dataToBind = dataToBind+'-B /project/ExtraLong/data/groupTemplates/versionThirteen:/data/output '
...
cmd = ['SINGULARITYENV_projectName=ExtraLong', 'singularity', 'exec',
        ...
        '/project/ExtraLong/images/antspriors_0.0.20.sif', '/scripts/run.sh']
