...
outdir = '/project/ExtraLong/data/groupTemplates/versionEighteen/'
...
dataToBind = dataToBind+'-B /project/ExtraLong/data/groupTemplates/versionEighteen:/data/output '
...
cmd = ['SINGULARITYENV_projectName=ExtraLong', 'SINGULARITYENV_NumSSTs=8',
        ...
        '/project/ExtraLong/images/antspriors_0.0.25.sif', '/scripts/run.sh']
