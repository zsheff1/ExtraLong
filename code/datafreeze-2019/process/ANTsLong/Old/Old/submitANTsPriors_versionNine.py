...
###
### Ellyn Butler
### January 27: Switch to antspriors:0.0.11
...
outdir = '/project/ExtraLong/data/groupTemplates/versionNine/'
...
dataToBind = dataToBind+'-B /project/ExtraLong/data/groupTemplates/versionNine:/data/output '
...
cmd = ['SINGULARITYENV_projectName=ExtraLong', 'singularity', 'exec',
        ...
        '/project/ExtraLong/images/antspriors_0.0.11.sif', '/scripts/run.sh']
