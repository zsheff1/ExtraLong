...
### Ellyn Butler
### December 10, 2020
### January 19: Switch to antsprior:0.0.7
...
outdir = '/project/ExtraLong/data/groupTemplates/versionFive/'
...
dataToBind = dataToBind+'-B /project/ExtraLong/data/groupTemplates/versionFive:/data/output '
...
cmd = ['SINGULARITYENV_projectName=ExtraLong', 'singularity', 'exec',
        ...
        '/project/ExtraLong/images/antspriors_0.0.7.sif', '/scripts/run.sh']
