...
### December 2: Switch to antsprior:0.0.2
...
outdir = '/project/ExtraLong/data/groupTemplates/versionTwo/'
...
dataToBind = dataToBind+'-B /project/ExtraLong/data/groupTemplates/versionTwo:/data/output'

cmd = ['SINGULARITYENV_projectName=ExtraLong', 'singularity', 'exec',
        '--writable-tmpfs', '--cleanenv', dataToBind,
        '/project/ExtraLong/images/antspriors_0.0.2.sif', '/scripts/run.sh']
