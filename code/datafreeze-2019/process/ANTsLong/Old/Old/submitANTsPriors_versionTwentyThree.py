...
outdir = '/project/ExtraLong/data/groupTemplates/versionTwentyThree/'
...
dataToBind = dataToBind+'-B /project/ExtraLong/data/groupTemplates/versionTwentyThree:/data/output '
...
cmd = ['SINGULARITYENV_projectName=ExtraLong', 'SINGULARITYENV_NumSSTs=8',
        ...
        '/project/ExtraLong/images/antspriors_0.0.33.sif', '/scripts/run.sh']
