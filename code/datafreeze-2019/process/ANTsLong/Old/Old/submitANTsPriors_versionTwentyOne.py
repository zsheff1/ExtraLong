...
outdir = '/project/ExtraLong/data/groupTemplates/versionTwentyOne/'
...
dataToBind = dataToBind+'-B /project/ExtraLong/data/groupTemplates/versionTwentyOne:/data/output '
...
cmd = ['SINGULARITYENV_projectName=ExtraLong', 'SINGULARITYENV_NumSSTs=8',
        ...
        '/project/ExtraLong/images/antspriors_0.0.28.sif', '/scripts/run.sh']
