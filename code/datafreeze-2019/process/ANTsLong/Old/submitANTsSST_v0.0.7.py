### This script submits qsub jobs calling the singularity container for antssst
### v 0.0.5, which strips skulls prior to template construction.
###
### Ellyn Butler
### January 11, 2021
...
outdir = '/project/ExtraLong/data/singleSubjectTemplates/antssst5/'
            ...
            for ses in sessions_bad:
                if os.path.exists(outdir+subj+'/'+ses):
                    ...
                    cmd = ['singularity', 'exec', '--writable-tmpfs', '--cleanenv',
                        ...
                        '/project/ExtraLong/images/antssst_0.0.7.sif', '/scripts/run.sh', sessions_string]
