...
demo_df <- demo_df[!(demo_df$bblid %in% c('93517', '101299', '113340', '122732',
  ...
  '86921', '125073')), ] #Might try again: 113340
  # Weird skulls: sub-86820, sub-86921, sub-125073
...
write.csv(template_df[, c('bblid', 'seslabel')], '~/Documents/ExtraLong/data/groupTemplates/subjsFromN752_set4.csv', row.names=FALSE)
