...
outdir = '/project/ExtraLong/data/groupTemplates/versionSeventeen/'
...
dataToBind = dataToBind+'-B /project/ExtraLong/data/groupTemplates/versionSeventeen:/data/output '
...
cmd = ['SINGULARITYENV_projectName=ExtraLong', 'singularity', 'exec',
        ...
        '/project/ExtraLong/images/antspriors_0.0.24.sif', '/scripts/run.sh']
