...
###
### Ellyn Butler
### January 27: Switch to antsprior:0.0.10
...
outdir = '/project/ExtraLong/data/groupTemplates/versionEight/'
...
dataToBind = dataToBind+'-B /project/ExtraLong/data/groupTemplates/versionEight:/data/output '
...
cmd = ['SINGULARITYENV_projectName=ExtraLong', 'singularity', 'exec',
        ...
        '/project/ExtraLong/images/antspriors_0.0.10.sif', '/scripts/run.sh']
