...
outdir = '/project/ExtraLong/data/corticalThickness/antslongct4/'
...
for subj in subjs:
    ...
    if len(directory_contents) > 1:
        ...
        cmd = ['SINGULARITYENV_projectName=ExtraLong', 'SINGULARITYENV_subLabel=bblid',
            ...
            '-B', sub_outdir+':/data/output', '/project/ExtraLong/images/antslongct_0.0.6.sif']
