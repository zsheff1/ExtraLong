...
outdir = '/project/ExtraLong/data/groupTemplates/versionSixteen/'
...
dataToBind = dataToBind+'-B /project/ExtraLong/data/groupTemplates/versionSixteen:/data/output '
...
cmd = ['SINGULARITYENV_projectName=ExtraLong', 'singularity', 'exec',
        ...
        '/project/ExtraLong/images/antspriors_0.0.23.sif', '/scripts/run.sh']
