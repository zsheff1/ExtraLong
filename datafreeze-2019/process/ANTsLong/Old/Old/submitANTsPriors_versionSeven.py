...
### Ellyn Butler
### December 10, 2020
### January 22: Switch to antsprior:0.0.9
...
outdir = '/project/ExtraLong/data/groupTemplates/versionSeven/'
...
dataToBind = dataToBind+'-B /project/ExtraLong/data/groupTemplates/versionSeven:/data/output '
...
cmd = ['SINGULARITYENV_projectName=ExtraLong', 'singularity', 'exec',
        ...
        '/project/ExtraLong/images/antspriors_0.0.9.sif', '/scripts/run.sh']
