...
### Ellyn Butler
### December 10, 2020
### December 11: Switch to antsprior:0.0.4
...
sstdir = '/project/ExtraLong/data/singleSubjectTemplates/antssst3/'
outdir = '/project/ExtraLong/data/groupTemplates/versionThree/'

if not os.path.isdir(outdir):
    os.mkdir(outdir)

# Load csv of subjects and sessions to include in SSTs
dat = pd.read_csv('/project/ExtraLong/data/groupTemplates/subjsFromN752_set2.csv')
...
dataToBind = dataToBind+'-B /project/ExtraLong/data/groupTemplates/versionThree:/data/output'

cmd = ['SINGULARITYENV_projectName=ExtraLong', 'singularity', 'exec',
        '--writable-tmpfs', '--cleanenv', dataToBind,
        '/project/ExtraLong/images/antspriors_0.0.4.sif', '/scripts/run.sh']
