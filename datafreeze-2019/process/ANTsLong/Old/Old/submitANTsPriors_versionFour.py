...
### Ellyn Butler
### December 10, 2020
### January 19: Switch to antsprior:0.0.6
...
outdir = '/project/ExtraLong/data/groupTemplates/versionFour/'
...
dataToBind = dataToBind+'-B /project/ExtraLong/data/groupTemplates/versionFour:/data/output '
...
cmd = ['SINGULARITYENV_projectName=ExtraLong', 'singularity', 'exec',
        ...
        '/project/ExtraLong/images/antspriors_0.0.6.sif', '/scripts/run.sh']
