...
### Ellyn Butler
### December 10, 2020
### January 19: Switch to antsprior:0.0.8
...
outdir = '/project/ExtraLong/data/groupTemplates/versionSix/'
...
dataToBind = dataToBind+'-B /project/ExtraLong/data/groupTemplates/versionSix:/data/output '
...
cmd = ['SINGULARITYENV_projectName=ExtraLong', 'singularity', 'exec',
        ...
        '/project/ExtraLong/images/antspriors_0.0.8.sif', '/scripts/run.sh']
