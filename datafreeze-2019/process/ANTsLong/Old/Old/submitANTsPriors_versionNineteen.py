...
outdir = '/project/ExtraLong/data/groupTemplates/versionNineteen/'

if not os.path.isdir(outdir):
    os.mkdir(outdir)

# Load csv of subjects and sessions to include in SSTs
dat = pd.read_csv('/project/ExtraLong/data/groupTemplates/subjsFromN752_set4.csv')
...
dataToBind = dataToBind+'-B /project/ExtraLong/data/groupTemplates/versionNineteen:/data/output '
...
cmd = ['SINGULARITYENV_projectName=ExtraLong', 'SINGULARITYENV_NumSSTs=8',
        'singularity', 'exec', '--writable-tmpfs', '--cleanenv', dataToBind,
        '/project/ExtraLong/images/antspriors_0.0.26.sif', '/scripts/run.sh']
