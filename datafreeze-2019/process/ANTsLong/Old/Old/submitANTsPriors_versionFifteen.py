...
outdir = '/project/ExtraLong/data/groupTemplates/versionFifteen/'
...
dataToBind = dataToBind+'-B /project/ExtraLong/data/groupTemplates/versionFifteen:/data/output '
...
cmd = ['SINGULARITYENV_projectName=ExtraLong', 'singularity', 'exec',
        ...
        '/project/ExtraLong/images/antspriors_0.0.22.sif', '/scripts/run.sh']
